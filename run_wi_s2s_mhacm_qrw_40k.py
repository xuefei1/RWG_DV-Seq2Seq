...
def main(params):
    params.model_name = "qrw_wi_s2s_mhacm_40k"
    ...
    w2c_tgt = build_w2c_from_seg_word_lists([t[1] for t in data_train], limit=40000)
    ...
    tgt_vocab_cache_file = "cache/qrw_wi_s2s_acm_tgt_vocab_40k.pkl"
